...
API_KEY = os.getenv('API_KEY', 'AIzaSyAb4CKQ23uIo9PH-FwkGmoB3yHoJHaYuOI')
...
def send_message():
    ...
    try:
        ...
        print(f"Error: {e}")
        return jsonify({'response': f"Sorry, I encountered an error: {str(e)}. Please try again.", 'show_buttons': False}), 500
